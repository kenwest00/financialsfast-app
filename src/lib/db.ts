...
export type ProductType = 'financials' | 'analysis' | 'underwriting';
...
export const PRODUCT_CONFIG = {
  financials: {
    ...
    includes: ['pnl', 'balance-sheet'],
  },
  analysis: {
    label: 'Preliminary Loan Analysis',
    shortLabel: 'Loan Analysis',
    price: 750,
    priceCents: 75000,
    priceDisplay: '$750',
    originalPrice: null,
    ...
    includes: ['pnl', 'balance-sheet', 'projections', 'analysis'],
  },
  underwriting: {
    ...
    includes: ['pnl', 'balance-sheet', 'projections', 'analysis', 'business-plan', 'application'],
  },
} as const;
